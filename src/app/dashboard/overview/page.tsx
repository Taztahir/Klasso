...
import { Users, UserCheck, DollarSign, BookOpen, Clock, CheckCircle2, ChevronDown, Calendar } from 'lucide-react';
    ...
    return (
        <div className="space-y-8">
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                {/* <div>
                    <h2 className="text-2.5xl font-black text-brandBlack tracking-tight">Welcome back, Zayd! 👋</h2>
                    <p className="text-xs font-bold text-gray-400 mt-1.5">Here's what's happening in your school today.</p>
                </div> */}
                    ...
                    <Card className="h-full border border-gray-100 bg-white shadow-sm rounded-3xl flex flex-col justify-between">
                        ...
                        <CardContent className="p-4 flex-1 flex flex-col justify-center">
                            <ul className="space-y-3.5">
                                {activities.map((act) => (
                                    <li key={act.id} className="flex items-start gap-3.5 p-2 rounded-xl border border-transparent hover:bg-slate-50/50 hover:border-slate-100 transition-all">
                                        ...
                                        <div className="flex flex-col min-w-0">
                                            <p className="text-[11px] font-bold text-gray-500 leading-normal">
                                                <span className="font-extrabold text-brandBlack">{act.user}</span> {act.action}{' '}
            ...
            {/* Attendance & Upcoming Events Grid */}
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                {/* Attendance Chart */}
