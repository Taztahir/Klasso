...
function ToggleGroup({
  ...
  return (
    <ToggleGroupPrimitive
      ...
      className={cn(
        "group/toggle-group flex w-fit flex-row items-center gap-[calc(var(--gap)*0.25rem)] data-[spacing=0]:data-[variant=outline]:rounded-2xl data-[orientation=vertical]:flex-col data-[orientation=vertical]:items-stretch",
        className
      )}
      {...props}
    >
